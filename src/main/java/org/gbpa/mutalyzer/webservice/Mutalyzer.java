...
public interface Mutalyzer {
    ...
    @RequestWrapper(localName = "upLoadGenBankRemoteFile", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.UpLoadGenBankRemoteFile")
    @ResponseWrapper(localName = "upLoadGenBankRemoteFileResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.UpLoadGenBankRemoteFileResponse")
     ...
     * @param variant
     * @return
     *     returns org.gbpa.mutalyzer.webservice.Mapping
     */
    @WebMethod(action = "mappingInfo")
    @WebResult(name = "mappingInfoResult", targetNamespace = "http://mutalyzer.nl/2.0/services")
    @RequestWrapper(localName = "mappingInfo", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.MappingInfo")
    @ResponseWrapper(localName = "mappingInfoResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.MappingInfoResponse")
    ...
    @RequestWrapper(localName = "upLoadGenBankLocalFile", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.UpLoadGenBankLocalFile")
    @ResponseWrapper(localName = "upLoadGenBankLocalFileResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.UpLoadGenBankLocalFileResponse")
    public String upLoadGenBankLocalFile(
        @WebParam(name = "content", targetNamespace = "http://mutalyzer.nl/2.0/services")
        String content);
     ...
     * @return
     *     returns org.gbpa.mutalyzer.webservice.TranscriptNameInfo
     */
    ...
    @RequestWrapper(localName = "getGeneAndTranscript", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetGeneAndTranscript")
    @ResponseWrapper(localName = "getGeneAndTranscriptResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetGeneAndTranscriptResponse")
     ...
     * @param genomicReference
     * @return
     *     returns org.gbpa.mutalyzer.webservice.TranscriptInfoArray
     */
    ...
    @RequestWrapper(localName = "getTranscriptsAndInfo", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetTranscriptsAndInfo")
    @ResponseWrapper(localName = "getTranscriptsAndInfoResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetTranscriptsAndInfoResponse")
     ...
     * @param variant
     * @return
     *     returns org.gbpa.mutalyzer.webservice.StringArray
     */
    @WebMethod(action = "numberConversion")
    @WebResult(name = "numberConversionResult", targetNamespace = "http://mutalyzer.nl/2.0/services")
    @RequestWrapper(localName = "numberConversion", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.NumberConversion")
    @ResponseWrapper(localName = "numberConversionResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.NumberConversionResponse")
    ...
    @RequestWrapper(localName = "getTranscriptsByGeneName", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetTranscriptsByGeneName")
    @ResponseWrapper(localName = "getTranscriptsByGeneNameResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetTranscriptsByGeneNameResponse")
    ...
    @RequestWrapper(localName = "ping", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.Ping")
    @ResponseWrapper(localName = "pingResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.PingResponse")
    public String ping();
    ...
    @RequestWrapper(localName = "sliceChromosome", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.SliceChromosome")
    @ResponseWrapper(localName = "sliceChromosomeResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.SliceChromosomeResponse")
    ...
    @RequestWrapper(localName = "submitBatchJob", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.SubmitBatchJob")
    @ResponseWrapper(localName = "submitBatchJobResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.SubmitBatchJobResponse")
    public BigInteger submitBatchJob(
    ...
    @RequestWrapper(localName = "chromAccession", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.ChromAccession")
    @ResponseWrapper(localName = "chromAccessionResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.ChromAccessionResponse")
     ...
     * @param variant
     * @return
     *     returns org.gbpa.mutalyzer.webservice.CheckSyntaxOutput
     */
    @WebMethod(action = "checkSyntax")
    @WebResult(name = "checkSyntaxResult", targetNamespace = "http://mutalyzer.nl/2.0/services")
    @RequestWrapper(localName = "checkSyntax", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.CheckSyntax")
    @ResponseWrapper(localName = "checkSyntaxResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.CheckSyntaxResponse")
    ...
    @RequestWrapper(localName = "getGeneName", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetGeneName")
    @ResponseWrapper(localName = "getGeneNameResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetGeneNameResponse")
     ...
     * @param build
     * @return
     *     returns org.gbpa.mutalyzer.webservice.Transcript
     */
    @WebMethod(action = "transcriptInfo")
    @WebResult(name = "transcriptInfoResult", targetNamespace = "http://mutalyzer.nl/2.0/services")
    @RequestWrapper(localName = "transcriptInfo", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.TranscriptInfoByNM")
    @ResponseWrapper(localName = "transcriptInfoResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.TranscriptInfoResponse")
    ...
    @RequestWrapper(localName = "getdbSNPDescriptions", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetdbSNPDescriptions")
    @ResponseWrapper(localName = "getdbSNPDescriptionsResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetdbSNPDescriptionsResponse")
     ...
     * @param reference
     * @return
     *     returns org.gbpa.mutalyzer.webservice.Allele
     */
    ...
    @RequestWrapper(localName = "descriptionExtract", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.DescriptionExtract")
    @ResponseWrapper(localName = "descriptionExtractResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.DescriptionExtractResponse")
    ...
    @RequestWrapper(localName = "getchromName", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetchromName")
    @ResponseWrapper(localName = "getchromNameResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetchromNameResponse")
     ...
     * @param variant
     * @return
     *     returns org.gbpa.mutalyzer.webservice.MutalyzerOutput
     */
    @WebMethod(action = "runMutalyzer")
    @WebResult(name = "runMutalyzerResult", targetNamespace = "http://mutalyzer.nl/2.0/services")
    @RequestWrapper(localName = "runMutalyzer", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.RunMutalyzer")
    @ResponseWrapper(localName = "runMutalyzerResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.RunMutalyzerResponse")
     ...
     * @param chrom
     * @return
     *     returns org.gbpa.mutalyzer.webservice.TranscriptMappingInfoArray
     */
    ...
    @RequestWrapper(localName = "getTranscriptsMapping", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetTranscriptsMapping")
    @ResponseWrapper(localName = "getTranscriptsMappingResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetTranscriptsMappingResponse")
    ...
    @RequestWrapper(localName = "getBatchJob", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetBatchJob")
    @ResponseWrapper(localName = "getBatchJobResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetBatchJobResponse")
     ...
     * @param createdSince
     * @return
     *     returns org.gbpa.mutalyzer.webservice.CacheEntryArray
     */
    @WebMethod(action = "getCache")
    @WebResult(name = "getCacheResult", targetNamespace = "http://mutalyzer.nl/2.0/services")
    @RequestWrapper(localName = "getCache", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetCache")
    @ResponseWrapper(localName = "getCacheResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetCacheResponse")
    ...
    @RequestWrapper(localName = "getTranscripts", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetTranscripts")
    @ResponseWrapper(localName = "getTranscriptsResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetTranscriptsResponse")
     ...
     * 
     * @return
     *     returns org.gbpa.mutalyzer.webservice.InfoOutput
     */
    @WebMethod(action = "info")
    @WebResult(name = "infoResult", targetNamespace = "http://mutalyzer.nl/2.0/services")
    @RequestWrapper(localName = "info", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.Info")
    @ResponseWrapper(localName = "infoResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.InfoResponse")
    ...
    @RequestWrapper(localName = "sliceChromosomeByGene", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.SliceChromosomeByGene")
    @ResponseWrapper(localName = "sliceChromosomeByGeneResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.SliceChromosomeByGeneResponse")
    ...
    @RequestWrapper(localName = "getTranscriptsRange", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetTranscriptsRange")
    @ResponseWrapper(localName = "getTranscriptsRangeResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.GetTranscriptsRangeResponse")
    ...
    @RequestWrapper(localName = "chromosomeName", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.ChromosomeName")
    @ResponseWrapper(localName = "chromosomeNameResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.ChromosomeNameResponse")
    ...
    @RequestWrapper(localName = "monitorBatchJob", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.MonitorBatchJob")
    @ResponseWrapper(localName = "monitorBatchJobResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.gbpa.mutalyzer.webservice.MonitorBatchJobResponse")
